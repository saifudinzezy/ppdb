...
?>
 ...
 <table border="1">
   <tr>
     <th colspan="25" style="color:black;"><b> Tanggal : <?php echo date('d M Y') ?></b></th>
   </tr>
   <tr>
     <th>No</th>
     <th>Tgl Daftar</th>
     ...
     <th>Status</th>
      ...
      <?php
        $sql->str_query("SELECT * FROM datadiri INNER JOIN dataortu ON datadiri.NoPDF = dataortu.NoPDF INNER JOIN datates ON datadiri.NoPDF = datates.NoPDF INNER JOIN datanilai ON datadiri.NoPDF = datanilai.NoPDF");
